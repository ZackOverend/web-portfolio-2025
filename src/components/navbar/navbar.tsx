  ...
  return (
    <>
      ...
      <div className='fixed z-50 flex h-16 w-screen items-center justify-between bg-black/30 px-8 py-4 backdrop-blur-md'>
          ...
          <div className='hidden items-center space-x-4 text-center text-[16px] font-thin tracking-wide sm:flex'>
            ...
            <Link href='https://github.com/ZackOverend' target='_blank'>
              <motion.svg
                ...
                whileHover={{ fill: '#c9510c', scale: 0.9 }} // Change fill color on hover
              >
            ...
            >
              <motion.svg
                ...
                xmlns='http://www.w3.org/2000/svg'
                preserveAspectRatio='xMidYMid'
                whileHover={{ fill: '#0B66C2', scale: 0.9 }} // Change fill color on hover
              >
        ...
        {/* Right side container - combines hamburger and contact button */}
